<template>
  <div class="addGroup">
    <a-form :label-col="{ span: 6 }" :wrapper-col="{ span: 18 }">
      <h2>基本信息</h2>
      <a-form-item label="用户名" v-bind="validateInfos.roleName">
        <a-input v-model:value="modelRef.roleName" />
      </a-form-item>
      <a-form-item label="密码" v-bind="validateInfos.roleName">
        <a-input v-model:value="modelRef.roleName" />
      </a-form-item>
      <a-form-item label="注册时间" v-bind="validateInfos.roleName">
        <a-input v-model:value="modelRef.roleName" />
      </a-form-item>
      <h2>角色权限</h2>
